...
/*!
  ...
  */
char libserial::Open(const char *Device,const unsigned int Bauds)
{
#if defined (_WIN32) || defined( _WIN64)
...
/*!
  ...
  */
char libserial::WriteChar(const char Byte){
#if defined (_WIN32) || defined( _WIN64)
...
/*!
     ...
     \return -1 error while writting data
  */
char libserial::WriteString(const char *String){
#if defined (_WIN32) || defined( _WIN64)
    DWORD dwBytesWritten;                                               // Number of bytes written
...
/*!
     ...
     \return -1 error while writting data
  */
char libserial::Write(const void *Buffer, const unsigned int NbBytes){
#if defined (_WIN32) || defined( _WIN64)
...
/*!
  ...
  */
char libserial::ReadChar(char *pByte,unsigned int TimeOut_ms){
#if defined (_WIN32) || defined(_WIN64)
...
/*!
  ...
  */
int libserial::ReadStringNoTimeOut(char *String,char FinalChar,unsigned int MaxNbBytes){
    ...
    while (NbBytes<MaxNbBytes){                                          // While the buffer is not full
        ret=ReadChar(&String[NbBytes]);									// Read a byte with the restant time
...
/*!
     ...
     \return -3 MaxNbBytes is reached
  */
int libserial::ReadString(char *String,char FinalChar,unsigned int MaxNbBytes,unsigned int TimeOut_ms){
    if (TimeOut_ms==0)
...
/*!
     ...
     \return -2 error while reading the byte
  */
int libserial::Read (void *Buffer,unsigned int MaxNbBytes,unsigned int TimeOut_ms){
#if defined (_WIN32) || defined(_WIN64)
    DWORD dwBytesRead = 0;
